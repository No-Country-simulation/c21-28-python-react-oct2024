    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return render(
                    request,
                    "ReservApp/turno.html",
                    {"mensaje": f"Bienvenido {usuario}"},
                )
            else:
                return render(
                    request,
                    "ReservApp/login.html",
                    {"form": form, "mensaje": "Error, datos incorrectos"},
                )
        else:
            return render(
                request,
                "ReservApp/login.html",
                {"form": form, "mensaje": "Error, formulario erróneo"},
            )
...
def logout_request(request):
    logout(request)
    return render(
        request, "ReservApp/index.html", {"mensaje": "Has cerrado sesion exitosamente"}
    )
